                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="fitSize">
                                            ...
                                            <asp:Button ID="ButtonCetak" runat="server" class="btn btn-default btn-xs" Style="margin-bottom: 0px" Text="Cetak" CommandName="Cetak" CommandArgument='<%# Eval("IDProyeksi") %>' OnClientClick='<%# Eval("CetakRAP") %>' />
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
