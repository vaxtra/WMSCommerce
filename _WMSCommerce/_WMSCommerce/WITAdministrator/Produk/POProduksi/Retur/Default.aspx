<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITAdministrator_Produk_POProduksi_Retur_Default" %>
                        ...
                        <div class="table-responsive">
                            <table class="table table-condensed table-hover table-bordered">
                                <thead>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBoxCariIDPOProduksiProdukRetur" runat="server" CssClass="form-control input-sm text-uppercase" Width="100%" onkeypress="return Func_ButtonCari(event)"></asp:TextBox></td>
                                        <td>
                                ...
                                <tbody>
                                    <asp:Repeater ID="RepeaterData" runat="server" OnItemCommand="RepeaterData_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <td><a href='<%# "Detail.aspx?id=" + Eval("IDPOProduksiProdukRetur") %>'><%# Eval("IDPOProduksiProdukRetur") %></a></td>
                                                ...
                                                <td class="text-right fitSize">
                                                    <asp:Button ID="ButtonCetak" CssClass="btn btn-default btn-xs" runat="server" Style="margin-bottom: 0px" CommandName="Cetak" CommandArgument='<%# Eval("IDPOProduksiProdukRetur") %>' OnClientClick='<%# Eval("Cetak") %>' Text="Cetak" />
                                                    <asp:Button ID="ButtonBatal" CssClass='<%# Eval("Batal")%>' runat="server" Style="margin-bottom: 0px" Text="Batal" CommandName="Batal" CommandArgument='<%# Eval("IDPOProduksiProdukRetur") %>' />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
