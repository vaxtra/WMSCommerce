<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Penerimaan.aspx.cs" Inherits="WITAdministrator_Produk_POProduksi_ProduksiKeVendor_Penerimaan" %>
        ...
        <ContentTemplate>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label bold">Tanggal Penerimaan</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="form-label bold">Jatuh Tempo</label>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <asp:Repeater ID="RepeaterDetail" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TextBoxSisaPesanan" Width="100%" CssClass="form-control text-right input-sm" runat="server" Text='<%# Eval("Sisa") %>' Enabled="false"></asp:TextBox></td>
                                                <td>
                    ...
                    <asp:Button ID="ButtonTerima" runat="server" Text="Simpan" CssClass="btn btn-success btn-sm" OnClick="ButtonTerima_Click" OnClientClick="if (!confirm('Are you sure to save this data?')) return false;" />
