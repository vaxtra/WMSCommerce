<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITAdministrator_Produk_POProduksi_ProduksiKeVendor_Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    <a href="Pengaturan.aspx" class="btn btn-success btn-sm">Tambah Production</a>
                                ...
                                <table class="table table-condensed table-hover table-bordered">
                                    <thead>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <asp:TextBox ID="TextBoxCariIDPOProduksiProduk" runat="server" CssClass="form-control text-right input-sm text-uppercase" Width="100%" onkeypress="return Func_ButtonCariPO(event)"></asp:TextBox>
                                            </td>
                                            <td>
