<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITAdministrator_Produk_POProduksi_ProduksiSendiri_Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    <a href="Pengaturan.aspx" class="btn btn-success btn-sm">Tambah In-House Production</a>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#tabInHouseProduction" id="InHouseProduction-tab" data-toggle="tab">In-House Production</a></li>
                                ...
                                <table class="table table-condensed table-hover table-bordered">
                                    <thead>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <asp:TextBox ID="TextBoxCariIDPOProduksiProduk" runat="server" CssClass="form-control text-right input-sm text-uppercase" Width="100%" onkeypress="return Func_ButtonCariPO(event)"></asp:TextBox></td>
                                            <td>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="text-right fitSize">
                                                        <a href='<%# "Proses.aspx?id=" + Eval("IDPOProduksiProduk") %>' <%# Eval("StatusKirim") %>>Kirim</a>
                                                        <asp:Button ID="ButtonCetak" runat="server" CssClass="btn btn-default btn-xs" Text="Cetak" OnClientClick='<%# Eval("CetakPO") %>' />
                                                        <asp:Button ID="ButtonHapus" CssClass='<%# Eval("Hapus") %>' runat="server" Style="margin-bottom: 0px" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDPOProduksiProduk") %>' />
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
