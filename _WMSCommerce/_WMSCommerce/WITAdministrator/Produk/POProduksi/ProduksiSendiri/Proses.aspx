<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Proses.aspx.cs" Inherits="WITAdministrator_Produk_POProduksi_ProduksiSendiri_Proses" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <asp:Button ID="ButtonSimpan" runat="server" Text="Simpan" CssClass="btn btn-primary btn-sm" OnClick="ButtonSimpan_Click" OnClientClick="if (!confirm('Are you sure to save this data?')) return false;" />
