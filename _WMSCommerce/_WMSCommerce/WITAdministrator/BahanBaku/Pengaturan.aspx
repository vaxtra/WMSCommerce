                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label bold">Kode Bahan Baku</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="bold">Satuan Besar</label>
                                        <br />
                                    ...
                                    <div class="col-md-3">
                                        <label class="bold">Satuan Kecil</label>
                                        <br />
                                    ...
                                    <div class="col-md-6">
                                        <label class="bold">Konversi</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="form-label bold">Harga Beli</label>
                                        <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="form-label bold">Minimum Stok</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label bold">Berat</label>
                                        <div class="controls">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="form-label bold">Kategori Bahan Baku</label><br />
