...
public partial class WITAdministrator_BahanBaku_Transfer_Terima_Default : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            RepeaterTransferProses.DataSource = DataTransferBahanBaku.Where(item => item.EnumJenisTransfer == (int)PilihanJenisTransfer.TransferProses);
            RepeaterTransferProses.DataBind();

            RepeaterTransferSelesai.DataSource = DataTransferBahanBaku.Where(item => item.EnumJenisTransfer == (int)PilihanJenisTransfer.TransferSelesai);
