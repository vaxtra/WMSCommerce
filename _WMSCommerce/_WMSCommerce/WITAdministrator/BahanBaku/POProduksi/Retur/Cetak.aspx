<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPageLaporan.master" AutoEventWireup="true" CodeFile="Cetak.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_Retur_Cetak" %>
        ...
        <div style="width: 100%; min-height: 95mm; border-radius: 5px; background: white;">
            <table style="width: 100%">
                ...
                <tr>
                    <td>SUPPLIER</td>
                    <td>:
                        <asp:Label runat="server" ID="LabelSupplier"></asp:Label></td>
                </tr>
                <tr>
                    <td>TANGGAL RETUR</td>
                    <td>:
            ...
            <table style="width: 100%;">
                ...
                <tfoot>
                    <tr>
                        <td colspan="5"><br />KETERANGAN : <asp:Label runat="server" ID="LabelKeterangan" Text="-"></asp:Label></td>
                    </tr>
                </tfoot>
            </table>
            <br />
