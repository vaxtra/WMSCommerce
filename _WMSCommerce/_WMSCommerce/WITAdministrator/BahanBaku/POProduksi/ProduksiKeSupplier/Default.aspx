<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_ProduksiKeSupplier_Default" %>
                                ...
                                <table class="table table-sm table-hover table-bordered">
                                    <thead>
                                        ...
                                        <tr class="thead-light">
                                            <th></th>
                                            <th>
                                                <asp:TextBox ID="TextBoxCariIDPOProduksiBahanBaku" runat="server" CssClass="form-control text-right input-sm text-uppercase" Width="100%" onkeypress="return Func_ButtonCariPO(event)"></asp:TextBox>
                                            </th>
                                            <th>
                                        ...
                                        <asp:Repeater ID="RepeaterDataPO" runat="server" OnItemCommand="RepeaterDataPO_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td colspan="2"><%# Eval("Tanggal").ToFormatHarga() %></td>
                                                    <td><%# Eval("Pegawai") %></td>
                                                    <td><%# Eval("Supplier") %></td>
                                ...
                                <table class="table table-sm table-hover table-bordered">
                                    <thead>
                                        ...
                                        <tr class="thead-light">
                                            <th></th>
                                            <th>
                                                <asp:TextBox ID="TextBoxCariIDPenerimaanPOProduksiBahanBaku" runat="server" CssClass="form-control text-right input-sm text-uppercase" Width="100%" onkeypress="return Func_ButtonCariPenerimaan(event)"></asp:TextBox>
                                            </th>
                                            <th>
