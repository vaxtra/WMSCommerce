<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_ProduksiKeSupplier_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="Server">
    Production Raw Material to Supplier Detail
</asp:Content>
                                    ...
                                    <asp:Repeater ID="RepeaterDetail" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="text-right fitSize"><%# Eval("HargaSupplier").ToFormatHarga() %></td>
                                                <td class="text-right fitSize"><%# Eval("PotonganHargaSupplier").ToFormatHarga() %></td>
                                                <td class="text-right fitSize"><%# Eval("Jumlah").ToFormatHarga() %></td>
                                                <td class="text-right fitSize"><strong><%# Eval("SubtotalHargaSupplier").ToFormatHarga() %></strong></td>
                                                <td class="text-right fitSize table-danger"><strong><%# Eval("Sisa").ToFormatHarga() %></strong></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
