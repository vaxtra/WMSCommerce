                                                ...
                                                <table class="table table-sm table-hover table-bordered">
                                                    <thead>
                                                        ...
                                                        <tr class="thead-light">
                                                            ...
                                                            <td class="fitSize">
                                                                <asp:Button ID="ButtonSimpanSatuan" CssClass="btn btn-success btn-block" runat="server" Text="Tambah" OnClick="ButtonSimpanSatuan_Click" /></td>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                ...
                                                <table class="table table-sm table-hover table-bordered">
                                                    <thead>
                                                        ...
                                                        <tr class="thead-light">
                                                            ...
                                                            <td class="fitSize">
                                                                <asp:Button ID="ButtonSimpanKategoriBahanBaku" CssClass="btn btn-success btn-block" runat="server" Text="Tambah" OnClick="ButtonSimpanKategoriBahanBaku_Click" ValidationGroup="GroupKategoriBahanBaku" /></td>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
