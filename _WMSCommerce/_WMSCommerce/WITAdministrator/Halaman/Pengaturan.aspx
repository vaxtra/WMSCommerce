<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Pengaturan.aspx.cs" Inherits="WITAdministrator_Halaman_Pengaturan" %>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="form-group">
                ...
                <asp:TextBox CssClass="form-control input-sm" ID="TextBoxIsi" Rows="15" runat="server" TextMode="MultiLine"></asp:TextBox>
            </div>
