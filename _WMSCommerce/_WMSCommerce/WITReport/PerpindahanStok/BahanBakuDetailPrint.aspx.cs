...
public partial class WITReport_PerpindahanStok_BahanBakuDetailPrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
            {
                ...
                LabelCariKategori.Text = Request.QueryString["IDKategori"] == "0" ? "Semua" : db.TBKategoriBahanBakus.FirstOrDefault(item => item.IDKategoriBahanBaku == Request.QueryString["IDKategori"].ToInt()).Nama;
                ...
                var Result = Laporan_Class.PerpindahanStokBahanBakuDetail(Request.QueryString["IDTempat"].ToInt(), Request.QueryString["IDPengguna"].ToInt(), Request.QueryString["kode"], Request.QueryString["IDBahanBaku"].ToInt(), Request.QueryString["IDSatuan"].ToInt(),Request.QueryString["IDKategori"].ToInt(), Request.QueryString["IDJenisPerpindahanStok"].ToInt(), Request.QueryString["Keterangan"], false);
            ...
            LabelJudul.Text = "Perpindahan Stok Bahan Baku Detail";
