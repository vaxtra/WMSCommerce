<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="StockCardBahanBaku.aspx.cs" Inherits="WITReport_PerpindahanStok_StockCardBahanBaku" %>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul id="myTab" class="nav nav-tabs">
                <li><a href="BahanBaku.aspx">Mutasi</a></li>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="form-group" style="font-weight: bold;">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <asp:DropDownList ID="DropDownListCariBahanBaku" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_Event"></asp:DropDownList>
                                    </div>
                                </div>
                                            ...
                                            <asp:Repeater ID="RepeaterLaporan" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><%# Eval("Status").ToBool() == true ? Eval("Masuk").ToFormatHarga() + " " + Eval("Satuan").ToString() : string.Empty %></td>
                                                        <td class="text-right"><%# Eval("Status").ToBool() == true ? string.Empty : Eval("Keluar").ToFormatHarga()  + " " + Eval("Satuan").ToString() %></td>
                                                        <td class="warning text-right"><strong><%# Eval("Saldo").ToFormatHarga()  + " " + Eval("Satuan").ToString() %></strong></td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </tbody>
