...
public partial class WITReport_PerpindahanStok_BahanBakuDetail : System.Web.UI.Page
{
    ...
    private void LoadData(bool GenerateExcel)
    {
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            var Result = Laporan_Class.PerpindahanStokBahanBakuDetail(DropDownListCariTempat.SelectedValue.ToInt(), DropDownListCariPengguna.SelectedValue.ToInt(), TextBoxCariKode.Text,  DropDownListCariBahanBaku.SelectedValue.ToInt(), DropDownListCariSatuan.SelectedValue.ToInt(), DropDownListCariKategori.SelectedValue.ToInt(), DropDownListCariJenisPerpindahanStok.SelectedValue.ToInt(), TextBoxCariKeterangan.Text, false);
            ...
            ButtonPrint.OnClientClick = "return popitup('BahanBakuDetailPrint.aspx" + Laporan_Class.TempPencarian + "')";
            #endregion
