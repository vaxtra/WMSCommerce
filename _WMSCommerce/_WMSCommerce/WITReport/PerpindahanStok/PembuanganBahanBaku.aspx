<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="PembuanganBahanBaku.aspx.cs" Inherits="WITReport_PerpindahanStok_PembuanganBahanBaku" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelPembuanganBahanBaku" runat="server">
        <ContentTemplate>
                    ...
                    <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                        <thead>
                            ...
                            <tr class="success" style="font-weight: bold;">
                                ...
                                <td></td>
                                <td class="text-right">
                                    <asp:Label ID="LabelTotalSubtotal" runat="server"></asp:Label>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <asp:UpdateProgress ID="updateProgressPembuanganBahanBaku" runat="server" AssociatedUpdatePanelID="UpdatePanelPembuanganBahanBaku">
                <ProgressTemplate>
                    <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: Black; filter: alpha(opacity=90); opacity: 0.5;">
                        <asp:Image ID="imgUpdateProgressPembuanganBahanBaku" runat="server" ImageUrl="/assets/images/ajax-loader.gif" AlternateText="Loading ..." ToolTip="Loading ..." Style="margin-top: 17%;" />
                    </div>
                </ProgressTemplate>
            </asp:UpdateProgress>
        </ContentTemplate>
