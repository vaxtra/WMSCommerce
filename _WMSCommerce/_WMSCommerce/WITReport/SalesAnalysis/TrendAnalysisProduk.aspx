<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="TrendAnalysisProduk.aspx.cs" Inherits="WITReport_Niion_TrendAnalysisProduk" %>
                        ...
                        <table class="table table-bordered table-hover table-condensed" style="width: 100%;">
                            <thead>
                                <tr class="active">
                                    <th class="text-left" rowspan="2">Channel</th>
                                    <th class="text-center">
                                        <asp:Label ID="LabelFooterByQtyTahunKemarin" runat="server"></asp:Label></th>
                                    <th class="text-center">
                                        <asp:Label ID="LabelFooterByQtyTahunIni" runat="server"></asp:Label></th>
                                    <th class="text-right" rowspan="2">Growth</th>
                                </tr>
                            </thead>
                                            ...
                                            <ItemTemplate>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <asp:Label ID="LabelSalesPerKota" runat="server" Text='<%# Eval("JumlahTransaksi").ToFormatHarga() %>'></asp:Label>
                                                        </td>
                                                        <td class="text-right">
