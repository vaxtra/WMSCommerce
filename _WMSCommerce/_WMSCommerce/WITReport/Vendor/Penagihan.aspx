<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Penagihan.aspx.cs" Inherits="WITReport_Vendor_Penagihan" %>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul id="myTab" class="nav nav-tabs">
                ...
                <li class="active"><a href="#tabPenagihan" id="Penagihan-tab" data-toggle="tab">Penagihan</a></li>
            </ul>
            <br />
                                    ...
                                    <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                                        <thead>
                                            ...
                                            <tr class="success" style="font-weight: bold;">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DropDownListCariVendor" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_Event"></asp:DropDownList></td>
                                                <td>
                                            ...
                                            <asp:Repeater ID="RepeaterPurchaseOrder" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="fitSize"><%# Eval("IDPOProduksiBahanBakuPenagihan") %></td>
                                                        <td><%# Eval("Tempat") %></td>
                                                        <td><%# Eval("Vendor") %></td>
                                                        <td class="fitSize"><%# Eval("Pengguna") %></td>
                                                        <td class="fitSize"><%# Eval("Tanggal") %></td>
                                                        <td class="text-right fitSize"><%# Eval("TotalPenerimaan") %></td>
                                                        <td class="text-right fitSize"><%# Eval("TotalRetur") %></td>
                                                        <td class="text-right fitSize"><%# Eval("TotalDownPayment") %></td>
                                                        <td class="text-right danger fitSize"><strong><%# Eval("TotalTagihan") %></strong></td>
                                                        <td class="text-right warning fitSize"><strong><%# Eval("TotalBayar") %></strong></td>
                                                        <td class="text-right fitSize"><%# Eval("Status") %></td>
