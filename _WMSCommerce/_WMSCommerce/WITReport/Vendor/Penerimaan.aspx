<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Penerimaan.aspx.cs" Inherits="WITReport_Vendor_Penerimaan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    ...
    <a href="PenerimaanDetail.aspx" class="btn btn-sm btn-info">Detail</a>
</asp:Content>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane active" id="tabPenerimaan">
                                            ...
                                            <asp:Repeater ID="RepeaterPurchaseOrder" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="text-right fitSize"><%# Eval("TotalTolakKeVendor") %></td>
