<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="PurchaseOrderDetail.aspx.cs" Inherits="WITReport_Vendor_PurchaseOrderDetail" %>
                                    ...
                                    <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                                        <thead>
                                            ...
                                            <tr class="success" style="font-weight: bold;">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DropDownListCariPemilikProdukPurchaseOrder" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_EventPurchaseOrder"></asp:DropDownList></td>
                                                <td>
                                                    <asp:DropDownList ID="DropDownListCariProdukPurchaseOrder" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_EventPurchaseOrder"></asp:DropDownList></td>
                                                <td>
                                                    <asp:DropDownList ID="DropDownListCariAtributProdukPurchaseOrder" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_EventPurchaseOrder"></asp:DropDownList></td>
                                                <td>
