...
public partial class WITReport_Top_ProdukVarianPrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            HtmlGenericControl PanelPeriode = (HtmlGenericControl)Page.Master.FindControl("PanelPeriode");
            #endregion
            ...
            RepeaterData.DataSource = LaporanTop_Class.TopKategori();
