<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPage.master" AutoEventWireup="true" CodeFile="Pembayaran.aspx.cs" Inherits="WITReport_NetRevenue_Pembayaran" %>
        ...
        <ContentTemplate>--%>
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3>Pembayaran <%= Result != null ? Result["Periode"] : "" %></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <asp:ListBox ID="ListBoxJenisPembayaran" runat="server" SelectionMode="Multiple" class="BootstrapMultiselect" multiple="multiple"></asp:ListBox>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Button CssClass="btn btn-warning btn-sm" Style="margin: 5px 5px 0 0" ID="ButtonApprove" runat="server" Text="Submit Payment Approval"
                                    OnClick="ButtonApprove_Click" Enabled="false" OnClientClick="if (!confirm('Are you sure ?')) return false;" />
                            </td>
                            <td>
                                <div style="margin: 5px 5px 0 0">
