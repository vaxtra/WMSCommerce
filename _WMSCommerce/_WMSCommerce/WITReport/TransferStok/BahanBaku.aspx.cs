...
public partial class WITReport_TransferStok_BahanBaku : System.Web.UI.Page
{
    ...
    private void LoadDataData(bool GenerateExcel)
    {
        //DEFAULT
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            ButtonPrintTransfer.OnClientClick = "return popitup('BahanBakuPrint.aspx" + Laporan_Class.TempPencarian + "')";
            #endregion
