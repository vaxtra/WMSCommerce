...
public partial class WITReport_TransferStok_ProdukDetailPrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
            {
                ...
                var Result = Laporan_Class.TransferProdukDetail(null, Request.QueryString["IDTempatPengirim"].ToInt(), 0, Request.QueryString["IDTempatPenerima"].ToInt(), 0, Request.QueryString["EnumStatusTransfer"].ToInt(), Request.QueryString["Kode"], Request.QueryString["IDPemilikProduk"].ToInt(), Request.QueryString["IDProduk"].ToInt(), Request.QueryString["IDAtributProduk"].ToInt(), Request.QueryString["IDKategoriProduk"].ToInt(), true);
            ...
            LabelJudul.Text = "Transfer Produk Detail";
