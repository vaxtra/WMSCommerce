<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dialog.aspx.cs" Inherits="plugins_tinyfilemanager_dialog" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script>
		    var ext_img=new Array(<% Response.Write(clsConfig.strAllowedImageExtensions); %>);
		    var allowed_ext=new Array(<% Response.Write(clsConfig.strAllowedAllExtensions); %>);
		    ...
		    Dropzone.options.myAwesomeDropzone = {
		        ...
		        maxFilesize: <% Response.Write(clsConfig.intMaxUploadSizeMb); %>, // MB
