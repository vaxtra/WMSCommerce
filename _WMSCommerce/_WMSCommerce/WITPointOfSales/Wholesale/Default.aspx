<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITPointOfSales_Wholesale_Default" %>
                                        ...
                                        <asp:Repeater ID="RepeaterStokKombinasiProduk" runat="server">
                                            <ItemTemplate>
                                                <tr runat="server" id="PanelStok">
                                                    ...
                                                    <td class="text-right success"><%# Pengaturan.FormatHarga(Eval("HargaJual")) %></td>
                                                    <td class="text-right warning">
                                                        <asp:Label ID="LabelJumlah" runat="server" Text='<%# Pengaturan.FormatHarga(Eval("Jumlah")) %>'></asp:Label></td>
                                                    <td class="text-right">
