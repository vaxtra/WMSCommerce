...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="card">
                <h4 class="card-header bg-smoke ">Role Default</h4>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            ...
            <div class="card">
                <h4 class="card-header bg-smoke ">Daftar Menu Default</h4>
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-bordered mb-0">
                        <tbody>
                            <asp:Repeater ID="RepeaterMenu" runat="server" OnItemCommand="RepeaterMenu_ItemCommand">
                                <ItemTemplate>
                                    <tr class="table-info">
                                        ...
                                        <td class="text-middle fitSize bold" colspan="3"><i class='<%# Eval("Icon") %>'></i>&nbsp;<%# Eval("Nama") %></td>
                                        ...
                                        <td class="fitSize text-middle text-center">
                                            <asp:Button ID="ButtonUbah" CssClass="btn btn-outline-info btn-xs" runat="server" Text="Ubah" CommandName="Ubah" CommandArgument='<%# Eval("IDMenubar") %>' />
                                            <asp:Button ID="ButtonHapus" CssClass="btn btn-outline-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDMenubar") %>' />
                                        </td>
                                    </tr>
                                    <asp:Repeater ID="RepeaterMenuLevel2" runat="server" OnItemCommand="RepeaterMenu_ItemCommand" DataSource='<%# Eval("MenuLevel2") %>'>
                                        <ItemTemplate>
                                            <tr class="table-warning">
                                                ...
                                                <td class="text-middle fitSize" colspan="2"><%# Eval("Nama") %></td>
                                                <td class="text-middle">
                                                    <a href='<%# Eval("Url") %>' class='<%# Eval("HaveChild").ToBool() == true ? "hidden" : string.Empty %>'><%# Eval("Url") %></a>
                                                </td>
                                            ...
                                            <asp:Repeater ID="RepeaterMenuLevel3" runat="server" OnItemCommand="RepeaterMenu_ItemCommand" DataSource='<%# Eval("MenuLevel3") %>'>
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="text-middle fitSize"><%# Eval("Nama") %></td>
                                                        <td class="text-middle"><a href='<%# Eval("Url") %>'><%# Eval("Url") %></a></td>
