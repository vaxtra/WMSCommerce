<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITAdministrator_Frontend_Default" %>
                            ...
                            <asp:Repeater ID="RepeaterPage" runat="server" OnItemCommand="RepeaterPage_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td colspan="2" class="fitSize table-secondary font-weight-bold"><%# Eval("Nama") %></td>
                                        <td colspan="2" class="text-center table-secondary fitSize">
