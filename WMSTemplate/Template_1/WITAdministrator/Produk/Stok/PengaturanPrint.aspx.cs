    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
            {
                ...
                Result = Laporan_Class.StokProduk_Class(Request.QueryString["do"], Request.QueryString["IDTempat"].ToInt(), Request.QueryString["JenisStokProduk"].ToInt(), Request.QueryString["Produk"], Request.QueryString["IDWarna"].ToInt(), Request.QueryString["IDPemilikProduk"].ToInt(), Request.QueryString["IDKategori"].ToInt(), Request.QueryString["Kode"], Request.QueryString["IDAtributProduk"].ToInt(), Request.QueryString["Harga"], Request.QueryString["Quantity"]);
