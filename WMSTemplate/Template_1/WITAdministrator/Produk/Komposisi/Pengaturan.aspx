<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Pengaturan.aspx.cs" Inherits="WITAdministrator_Produk_Komposisi_Pengaturan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="Server">
    <asp:Label ID="LabelNamaKombinasiProduk" runat="server"></asp:Label>
</asp:Content>
            ...
            <div class="card">
                <div class="card-header bg-smoke">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item"><a href="#tabBiayaProduksi" role="tab" id="BiayaProduksi-tab" class="nav-link" data-toggle="tab">Biaya produksi</a></li>
                    </ul>
                </div>
                <div class="card-body">
                                        ...
                                        <table class="table table-sm table-hover table-bordered mb-0">
                                            <thead>
                                                ...
                                                <tr class="thead-light">
                                                    ...
                                                    <th colspan="2">
                                                        <asp:Button ID="ButtonSimpanKomposisi" runat="server" CssClass="btn btn-success btn-sm btn-block" Text="Simpan" OnClick="ButtonSimpanKomposisi_Click" /></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="text-center fitSize">
                                                                <asp:Button ID="ButtonHapus" CssClass="btn btn-outline-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDBahanBaku") %>' />
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                                ...
                                                <asp:Repeater ID="RepeaterBiayaProduksi" runat="server" OnItemCommand="RepeaterBiayaProduksi_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="text-center fitSize">
                                                                <asp:Button ID="ButtonHapus" CssClass="btn btn-outline-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDJenisBiayaProduksi") %>' />
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
            ...
            <asp:UpdatePanel ID="UpdatePanelInfo" runat="server">
                <ContentTemplate>
                    <div class="form-group">
                        <div class="card">
                            <h4 class="card-header bg-smoke">Jenis Biaya</h4>
                            <div class="card-body">
                                <table class="table table-sm table-hover table-bordered mb-0">
                                    <thead>
                                        <tr class="thead-light">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="text-right fitSize">
                                                        <asp:Button ID="ButtonUbah" CssClass="btn btn-outline-info btn-xs" runat="server" Text="Ubah" CommandName="Ubah" CommandArgument='<%# Eval("IDJenisBiayaProduksi") %>' />
                                                        <asp:Button ID="ButtonHapus" CssClass="btn btn-outline-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDJenisBiayaProduksi") %>' />
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
