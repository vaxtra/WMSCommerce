            ...
            <div class="card">
                <div class="card-header bg-gradient-black">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item"><a href="#tabBiayaProduksi" role="tab" id="BiayaProduksi-tab" class="nav-link font-weight-normal" data-toggle="tab">Biaya produksi</a></li>
                    </ul>
                </div>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="text-center fitSize">
                                                            <asp:Button ID="ButtonHapus" CssClass="btn btn-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDBahanBaku") %>' />
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                    ...
                                    <table class="table table-sm table-hover table-bordered mb-0">
                                        <thead>
                                            ...
                                            <tr class="thead-light">
                                                ...
                                                <th>
                                                    <asp:Button ID="ButtonSimpanBiayaProduksi" CssClass="btn btn-success btn-sm btn-block" runat="server" Text="Simpan" OnClick="ButtonSimpanBiayaProduksi_Click" /></th>
                                            </tr>
                                        </thead>
                                        <tbody>
