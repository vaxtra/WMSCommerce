...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    <a href="/WITAdministrator/Import/KomposisiProduk.aspx" class="btn btn-secondary btn-const mr-1">Import</a>
                                                ...
                                                <asp:Repeater ID="RepeaterKombinasiProduk" runat="server" OnItemCommand="RepeaterKombinasiProduk_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="fitSize text-center"><a href='<%# "Pengaturan.aspx?id=" + Eval("IDKombinasiProduk") %>' class="btn btn-outline-info btn-xs">Ubah</a></td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </tbody>
