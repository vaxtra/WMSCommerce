                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="align-middle fitSize">
                                                                    <img src='/images/cover/<%# Eval("IDProduk") %>.jpg?w=75' /></td>
                                                                <td class="text-center"><%# Eval("Kategori") %></td>
                                                                <td class="text-center text-middle fitSize">
                                                                ...
                                                                <td class="fitSize"><a href='<%# "Pengaturan.aspx?id=" + Eval("IDProduk") %>' class="btn btn-outline-info btn-xs">Ubah</a></td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                </tbody>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="text-right fitSize">
                                                                <asp:Button ID="ButtonUbah" runat="server" CssClass="btn btn-outline-info btn-xs" Text="Ubah" CommandName="Ubah" CommandArgument='<%# Eval("IDPemilikProduk") %>' />
                                                                <asp:Button ID="ButtonHapus" runat="server" CssClass="btn btn-outline-danger btn-xs" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDPemilikProduk") %>' OnClientClick='<%# "return confirm(\"Apakah Anda yakin menghapus data No." + Eval("IDPemilikProduk") + "\")" %>' />
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                                        ...
                                                        <asp:Repeater ID="RepeaterWarna" runat="server" OnItemCommand="RepeaterWarna_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td><%# Eval("Nama") %></td>
                                                                    <td class="text-right fitSize">
                                                                        <asp:Button ID="ButtonUbah" CssClass="btn btn-outline-info btn-xs" runat="server" Text="Ubah" CommandName="Ubah" CommandArgument='<%# Eval("IDWarna") %>' />
                                                                        <asp:Button ID="ButtonHapus" CssClass="btn btn-outline-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDWarna") %>' OnClientClick='<%# "return confirm(\"Apakah Anda yakin menghapus data No." + Eval("IDWarna") + "\")" %>' />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                        ...
                                                        <asp:Repeater ID="RepeaterAtributProduk" runat="server" OnItemCommand="RepeaterAtributProduk_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td><%# Eval("Nama") %></td>
                                                                    <td class="text-right fitSize">
                                                                        <asp:Button ID="ButtonUbah" CssClass="btn btn-outline-info btn-xs" runat="server" Text="Ubah" CommandName="Ubah" CommandArgument='<%# Eval("IDAtributProduk") %>' />
                                                                        <asp:Button ID="ButtonHapus" CssClass="btn btn-outline-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDAtributProduk") %>' OnClientClick='<%# "return confirm(\"Apakah Anda yakin menghapus data No." + Eval("IDAtributProduk") + "\")" %>' />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                        ...
                                                        <asp:Repeater ID="RepeaterKategoriProduk" runat="server" OnItemCommand="RepeaterKategoriProduk_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td><%# Eval("Nama") %></td>
                                                                    <td class="text-right fitSize">
                                                                        <asp:Button ID="ButtonUbah" CssClass="btn btn-outline-info btn-xs" runat="server" Text="Ubah" CommandName="Ubah" CommandArgument='<%# Eval("IDKategoriProduk") %>' />
                                                                        <asp:Button ID="ButtonHapus" CssClass="btn btn-outline-danger btn-xs" runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDKategoriProduk") %>' OnClientClick='<%# "return confirm(\"Apakah Anda yakin menghapus data No." + Eval("IDKategoriProduk") + "\")" %>' />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
