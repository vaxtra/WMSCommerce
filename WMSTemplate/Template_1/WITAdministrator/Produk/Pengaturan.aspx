        ...
        <div class="card-body">
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane" id="tabVarian">
                    <asp:UpdatePanel ID="UpdatePanelVarian" runat="server">
                        <ContentTemplate>
                            <div class="form-group">
                            ...
                            <asp:UpdateProgress ID="updateProgressVarian" runat="server" AssociatedUpdatePanelID="UpdatePanelVarian">
                                <ProgressTemplate>
                                    <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: Black; filter: alpha(opacity=90); opacity: 0.5;">
                                        <asp:Image ID="imgUpdateProgressVarian" runat="server" ImageUrl="/assets/images/ajax-loader.gif" AlternateText="Loading ..." ToolTip="Loading ..." Style="margin-top: 17%;" />
                                    </div>
                                </ProgressTemplate>
                            </asp:UpdateProgress>
                        </ContentTemplate>
                ...
                <div class="tab-pane" id="tabPhoto">
                    <asp:UpdatePanel ID="UpdatePanelFoto" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:UpdateProgress ID="updateProgressFoto" runat="server" AssociatedUpdatePanelID="UpdatePanelFoto">
                                <ProgressTemplate>
                                    <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: Black; filter: alpha(opacity=90); opacity: 0.5;">
                                        <asp:Image ID="imgUpdateProgressFoto" runat="server" ImageUrl="/assets/images/ajax-loader.gif" AlternateText="Loading ..." ToolTip="Loading ..." Style="margin-top: 17%;" />
                                    </div>
                                </ProgressTemplate>
                            </asp:UpdateProgress>
                        </ContentTemplate>
