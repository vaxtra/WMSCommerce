...
public partial class WITAdministrator_Produk_POProduksi_PurchaseOrder_Default : System.Web.UI.Page
{
    ...
    private void LoadDataPenerimaan(DataClassesDatabaseDataContext db)
    {
        ...
        RepeaterDataPenerimaan.DataSource = db.TBPenerimaanPOProduksiProduks.Where(item => item.TBPOProduksiProduk.IDTempat == pengguna.IDTempat && item.TBPOProduksiProduk.EnumJenisProduksi == (int)PilihanEnumJenisProduksi.PurchaseOrder &&
            ...
            .Select(item => new
            {
                ...
                item.Grandtotal,
                Status = item.TBPOProduksiProdukPenagihan != null ? item.TBPOProduksiProdukPenagihan.StatusPembayaran == false ? "<span class=\"badge badge-warning\">Kontra</span>" : "<span class=\"badge badge-success\">Lunas</span>" : "<span class=\"badge badge-secondary\">Baru</span>",
