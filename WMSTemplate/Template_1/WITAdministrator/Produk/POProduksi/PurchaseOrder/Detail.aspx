                                    ...
                                    <asp:Repeater ID="RepeaterDetail" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="text-right"><strong><%# Eval("SubtotalHargaVendor").ToFormatHarga() %></strong></td>
                                                <td class="text-right table-danger"><strong><%# Eval("Sisa").ToFormatHargaBulat() %></strong></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
