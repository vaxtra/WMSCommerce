                                ...
                                <table class="table table-sm table-hover table-bordered">
                                    <thead>
                                        ...
                                        <tr>
                                            <th></th>
                                            <th>
                                                <asp:TextBox ID="TextBoxCariIDPOProduksiProduk" runat="server" CssClass="form-control text-right input-sm text-uppercase" Width="100%" onkeypress="return Func_ButtonCariPO(event)"></asp:TextBox></th>
                                            <th>
