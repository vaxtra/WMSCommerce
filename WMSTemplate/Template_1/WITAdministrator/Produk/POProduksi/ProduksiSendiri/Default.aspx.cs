...
public partial class WITAdministrator_Produk_POProduksi_ProduksiSendiri_Default : System.Web.UI.Page
{
    ...
    private void LoadDataPO(DataClassesDatabaseDataContext db)
    {
        ...
        RepeaterDataPO.DataSource = db.TBPOProduksiProduks.Where(item => item.IDTempat == pengguna.IDTempat && item.EnumJenisProduksi == (int)PilihanEnumJenisProduksi.ProduksiSendiri &&
