                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-hover table-bordered">
                                <thead>
                                    ...
                                    <tr class="thead-light">
                                        <th>
                                            <asp:TextBox ID="TextBoxCariIDPOProduksiProdukRetur" runat="server" CssClass="form-control input-sm text-uppercase" Width="100%" onkeypress="return Func_ButtonCari(event)"></asp:TextBox></th>
                                        <th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="text-right fitSize">
                                                    <asp:Button ID="ButtonCetak" CssClass="btn btn-light btn-xs" runat="server" Style="margin-bottom: 0px" CommandName="Cetak" CommandArgument='<%# Eval("IDPOProduksiProdukRetur") %>' OnClientClick='<%# Eval("Cetak") %>' Text="Cetak" />
