                        ...
                        <table class="table table-sm table-hover table-bordered">
                            <thead>
                                ...
                                <tr class="thead-light">
                                    <th></th>
                                    <th>
                                        <asp:TextBox ID="TextBoxCariIDIDPOProduksiProdukPenagihan" runat="server" CssClass="form-control input-sm text-uppercase" onkeypress="return Func_ButtonCari(event)"></asp:TextBox></th>
                                    <th>
