...
public partial class WITAdministrator_Import_Supplier : System.Web.UI.Page
{
    ...
    protected void ButtonUpload_Click(object sender, EventArgs e)
    {
        if (FileUploadVendor.HasFile)
        {
            ...
            string lokasiFile = Server.MapPath("/file_excel/Supplier/Import/") + "Import Supplier" + DateTime.Now.ToString("d MMMM yyyy hh.mm.ss") + ".xls";
