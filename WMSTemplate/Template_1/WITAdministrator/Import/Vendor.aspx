<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Vendor.aspx.cs" Inherits="WITAdministrator_Import_Vendor" %>
    ...
    <div class="card">
        <div class="card-body">
            <div class="form-group">
                <a href="/file_excel/template/(Format) Vendor.xls">download Vendor List template</a>
            </div>
            <div class="form-group">
