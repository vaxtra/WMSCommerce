<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="HargaSupplier.aspx.cs" Inherits="WITAdministrator_Import_HargaSupplier" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="Server">
    Import Excel Harga Supplier
</asp:Content>
    ...
    <div class="card">
        <div class="card-body">
            <div class="form-group">
                <a>Template/(Format) Harga Supplier.xls">download Harga Supplier List template</a>
            </div>
            <div class="form-group">
