...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    <a href="/WITAdministrator/Import/KomposisiBahanBaku.aspx" class="btn btn-dark btn-const mr-1">Import</a>
    ...
    <asp:UpdatePanel ID="UpdatePanelTitleRight" runat="server">
        <ContentTemplate>
            <asp:Button ID="ButtonPerbaharuiSemuaHargaPokokProduksiBahanBaku" runat="server" CssClass="btn btn-primary" Text="Perbaharui Semua HPP" OnClick="ButtonPerbaharuiSemuaHargaPokokProduksiBahanBaku_Click" />
                                        ...
                                        <table class="table table-sm table-hover table-bordered TableSorter">
                                            <thead>
                                                <tr class="thead-light">
                                                    <th>No</th>
                                                    <th>Bahan Baku <span aria-hidden="true" class="glyphicon glyphicon-sort pull-right"></span></th>
                                                    <th>Satuan <span aria-hidden="true" class="glyphicon glyphicon-sort pull-right"></span></th>
                                                ...
                                                <asp:Repeater ID="RepeaterBahanBaku" runat="server" OnItemCommand="RepeaterBahanBaku_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td><%# Eval("Satuan") %></td>
                                                            <td class="fitSize">
                                                                <asp:ImageButton ID="ImageButtonUpdate" runat="server" ImageUrl="/assets/images/refresh.png" CssClass="pull-left" Style="vertical-align: middle" BorderStyle="None" CommandName="UbahHargaPokokProduksi" CommandArgument='<%# Eval("IDBahanBaku") %>' Visible='<%# decimal.Parse(Eval("HargaPokokProduksi").ToString()) != decimal.Parse(Eval("HargaBeli").ToString()) ? true : false %>' /></td>
                                                            <td class='<%# Eval("HargaBeli").ToFormatHarga() == Eval("HargaPokokProduksi").ToFormatHarga() ? "text-right success" : "text-right danger" %>'><%# Eval("HargaBeli").ToFormatHarga() %></td>
                                                            ...
                                                            <td class="fitSize text-center"><a href='<%# "Pengaturan.aspx?id=" + Eval("IDBahanBaku") %>' class="btn btn-xs btn-info">Ubah</a></td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </tbody>
