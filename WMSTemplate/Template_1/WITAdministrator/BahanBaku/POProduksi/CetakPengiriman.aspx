<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPageLaporan.master" AutoEventWireup="true" CodeFile="CetakPengiriman.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_CetakPengiriman" %>
            ...
            <table class="table table-condensed table-hover table-bordered" style="width: 100%">
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <br />
                        <h3><asp:Label ID="LabelIDPengirimanPOProduksiBahanBaku" runat="server" Text="-"></asp:Label></h3>
                    </td>
                    <td rowspan="2" style="width: 30%">
