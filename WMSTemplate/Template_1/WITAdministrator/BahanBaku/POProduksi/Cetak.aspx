<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPageLaporan.master" AutoEventWireup="true" CodeFile="Cetak.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_Cetak" %>
        ...
        <div class="col-xs-12">
            <table class="table table-condensed table-hover table-bordered" style="width: 100%">
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <br />
                        <h3>
                            <asp:Label ID="LabelIDPOProduksiBahanBaku" runat="server" Text="-"></asp:Label></h3>
                    </td>
                    <td rowspan="2" style="width: 30%">
            ...
            <table class="table table-condensed table-hover table-bordered">
                ...
                <tbody>
                    <asp:Repeater ID="RepeaterDetail" runat="server" OnItemCreated="RepeaterDetail_ItemCreated">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td id="bodyHarga" runat="server" class="text-right"><%# Eval("HargaSupplier").ToFormatHarga() %></td>
                                <td id="bodyPotongan" runat="server" class="text-right"><%# Eval("PotonganHargaSupplier").ToFormatHarga() %></td>
                    ...
                    <tr class="bold">
                        <td colspan="7" class="text-right active"><b>TOTAL</b></td>
                    ...
                    <table class="table table-condensed table-hover table-bordered">
                        <thead>
                            <tr class="active">
                                ...
                                <th class="text-center" style="width: 10%;">Kebutuhan</th>
                                <th class="text-center" style="width: 15%;">Subtotal</th>
                            </tr>
                        </thead>
                        <tbody>
