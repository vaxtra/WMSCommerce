<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_PurchaseOrder_Default" %>
                                ...
                                <table class="table table-sm table-hover table-bordered">
                                    <thead>
                                        ...
                                        <tr class="thead-light">
                                            <th></th>
                                            <th>
                                                <asp:TextBox ID="TextBoxCariIDPOProduksiBahanBaku" runat="server" CssClass="form-control input-sm text-uppercase" onkeypress="return Func_ButtonCariPO(event)"></asp:TextBox></th>
                                            <th>
                                            ...
                                            <th>
                                                <asp:DropDownList ID="DropDownListCariSupplierPO" runat="server" CssClass="select2" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="Event_CariPO">
                                                </asp:DropDownList></th>
                                            <th></th>
                                            <th class="fitSize">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="text-center fitSize">
                                                        ...
                                                        <asp:Button ID="ButtonHapus" CssClass='<%#  Eval("Hapus") %>' runat="server" Text="Hapus" CommandName="Hapus" CommandArgument='<%# Eval("IDPOProduksiBahanBaku") %>' />
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <table class="table table-sm table-hover table-bordered">
                                    <thead>
                                        ...
                                        <tr class="thead-light">
                                            <th></th>
                                            <th>
                                                <asp:TextBox ID="TextBoxCariIDPenerimaanPOProduksiBahanBaku" runat="server" CssClass="form-control input-sm text-uppercase" onkeypress="return Func_ButtonCariPenerimaan(event)"></asp:TextBox></th>
                                            <th>
                                            ...
                                            <th>
                                                <asp:DropDownList ID="DropDownListCariSupplierPenerimaan" runat="server" CssClass="select2" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="Event_CariPenerimaan">
                                                </asp:DropDownList></th>
                                            <th></th>
                                            <th>
                                                <asp:DropDownList ID="DropDownListCariStatusPenerimaan" runat="server" Width="100%" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="Event_CariPenerimaan">
