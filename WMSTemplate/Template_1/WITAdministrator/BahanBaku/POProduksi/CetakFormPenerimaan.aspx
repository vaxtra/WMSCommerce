<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPageLaporan.master" AutoEventWireup="true" CodeFile="CetakFormPenerimaan.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_CetakFormPenerimaan" %>
                    ...
                    <asp:Repeater ID="RepeaterDetail" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center"><%# Eval("KodeBahanBaku") %></td>
