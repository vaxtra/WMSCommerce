<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Proses.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_ProduksiKeSupplier_Proses" %>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="input-group" style="width: 100%;">
                                                            ...
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text" style="width: 80px;">
                                                                    <asp:Label ID="Label1" runat="server" CssClass="form-label" Font-Bold="true" Font-Size="Small" Text='<%# Eval("SatuanPO") %>'></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td <%# Eval("Stok").ToDecimal() < Eval("Sisa").ToDecimal() ? "class='text-right danger'" : "class='text-right'" %>>
                                                        <div class="input-group" style="width: 100%;">
                                                            ...
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text" style="width: 80px;">
                                                                    <asp:Label ID="Label2" runat="server" CssClass="form-label" Font-Bold="true" Font-Size="Small" Text='<%# Eval("SatuanStok") %>'></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group" style="width: 100%;">
                                                            ...
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text" style="width: 80px;">
                                                                    <asp:Label ID="Label3" runat="server" CssClass="form-label" Font-Bold="true" Font-Size="Small" Text='<%# Eval("SatuanPO") %>'></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
