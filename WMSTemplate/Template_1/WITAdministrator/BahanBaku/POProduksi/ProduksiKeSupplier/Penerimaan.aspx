<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Penerimaan.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_ProduksiKeSupplier_Penerimaan" %>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="card">
                            <h4 class="card-header bg-smoke">Production Raw Material to Supplier</h4>
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <asp:Repeater ID="RepeaterDetail" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="danger">
                                                        <div class="input-group w-auto">
                                                            <asp:TextBox ID="TextBoxJumlahTolakKeSupplier" onfocus="this.select();" CssClass="form-control InputDesimal text-right JumlahTolak input-sm" runat="server" Text="0.00"></asp:TextBox>
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text" style="width: 80px;">
                                                                    <asp:Label ID="LabelSatuanTolakSupplier" runat="server" CssClass="form-label" Font-Bold="true" Font-Size="Small" Text='<%# Eval("Satuan") %>'></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
            ...
            $(".JumlahTolak").each(function () {
                $(this).blur(function () {
                    ...
                    for (var i = 1; i in daftarStok.rows; i++) {
                        ...
                        var hasil = parseFloat(JumlahDatang) - parseFloat(JumlahTerima);
                        r.getElementsByTagName("input")[3].value = parseFloat(hasil).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,");
                    }
                });
            });
        });
