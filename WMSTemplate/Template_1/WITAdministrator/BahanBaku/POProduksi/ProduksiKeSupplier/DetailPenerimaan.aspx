<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="DetailPenerimaan.aspx.cs" Inherits="WITAdministrator_BahanBaku_POProduksi_ProduksiKeSupplier_DetailPenerimaan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="Server">
    Penerimaan Production to Supplier Raw Material
</asp:Content>
