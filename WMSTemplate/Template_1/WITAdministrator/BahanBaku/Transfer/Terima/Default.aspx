<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WITAdministrator_BahanBaku_Transfer_Terima_Default" %>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="text-right fitSize">
                                                                    <a class="btn btn-primary btn-xs" href="Pengaturan.aspx?id=<%# Eval("IDTransferBahanbaku") %>">Terima</a>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
