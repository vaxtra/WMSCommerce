<%@ Page Title="" Language="C#" MasterPageFile="frontend/MasterPage.master" AutoEventWireup="true" CodeFile="DynamicPage.aspx.cs" Inherits="BlogDetail" %>
        ...
        <div class="container">
            <article class="b-post b-post-full-2 clearfix">
                <asp:Repeater ID="RepeaterPost" runat="server" OnItemDataBound="RepeaterPost_ItemDataBound">
                    <ItemTemplate>
                        <asp:HiddenField ID="hiddenID" runat="server" Value='<%# Eval("IDPost")%>' />
                        <div class="row">
                            <div class="col-xs-12">
                        ...
                        <div class="entry-main">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="entry-media">
                                        <img src="/frontend/assets/media/content/posts/carousel/img-lg-1.jpg" alt="foto" class="img-responsive" />
                                    </div>
                                </div>
                            </div>
                            <div class="entry-content">
                                <div class="row">
                                    <div class="col-md-12">
                                        <asp:Repeater ID="RepeaterPostDetail" runat="server">
                                        <ItemTemplate>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div data-pagination="false" data-navigation="true" data-single-item="true" data-auto-play="7000" data-transition-style="fade" data-main-text-animation="true" data-after-init-delay="3000" data-after-move-delay="1000" data-stop-on-hover="true" class="post-carousel owl-carousel owl-theme owl-theme_mod-b enable-owl-carousel">
                                            <img src="/frontend/assets/media/content/posts/carousel/img-lg-2.jpg" alt="foto" class="img-responsive" /><img src="/frontend/assets/media/content/posts/carousel/img-lg-1.jpg" alt="foto" class="img-responsive" />
                                        </div>
                                    </div>
                                </div>
                                <%--  <div class="row">
