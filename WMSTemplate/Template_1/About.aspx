<%@ Page Title="" Language="C#" MasterPageFile="frontend/MasterPage.master" AutoEventWireup="true" CodeFile="About.aspx.cs" Inherits="BlogDetail" %>
                            ...
                            <asp:Repeater ID="RepeaterPostDetail" runat="server" DataSource='<%# Eval("DataSourcePostDetail") %>'>
                                <ItemTemplate>
                                    ...
                                    <div class='<%# Eval("ClassTeks") %>'>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="entry-subtitle"><%# Eval("Konten") %>
                                                </p>
                                            </div>
                                        </div>
