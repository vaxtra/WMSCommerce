<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="BahanBakuDetail.aspx.cs" Inherits="WITReport_TransferStok_BahanBakuDetail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="Server">
    Laporan Transfer Bahan Baku Detail
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    <asp:Button ID="ButtonPrintTransferDetail" runat="server" Text="Print" CssClass="btn btn-info btn-sm" />
    <asp:Button ID="ButtonExcelTransferDetail" runat="server" Text="Excel" CssClass="btn btn-info btn-sm" OnClick="ButtonExcelTransferDetail_Click" />
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul id="myTab" class="nav nav-tabs">
                <li><a href="../PerpindahanStok/BahanBaku.aspx">Mutasi</a></li>
                <li><a href="../PerpindahanStok/StockCardBahanBaku.aspx">Stock Card</a></li>
                                    ...
                                    <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                                        <thead>
                                            ...
                                            <tr class="success" style="font-weight: bold;">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DropDownListCariBahanBakuTransferDetail" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_EventTransferDetail"></asp:DropDownList></td>
                                                <td>
                                                    <asp:DropDownList ID="DropDownListCariSatuanTransferDetail" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_EventTransferDetail"></asp:DropDownList></td>
                                                <td>
