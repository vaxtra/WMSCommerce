<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="BahanBaku.aspx.cs" Inherits="WITReport_TransferStok_BahanBaku" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    ...
    <a href="BahanBakuDetail.aspx" class="btn btn-sm btn-info">Detail</a>
</asp:Content>
                                            ...
                                            <asp:Repeater ID="RepeaterTransfer" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="fitSize"><%# Eval("IDTransferBahanBaku") %></td>
