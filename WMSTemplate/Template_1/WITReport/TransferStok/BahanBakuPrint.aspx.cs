...
public partial class WITReport_TransferStok_BahanBakuPrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
            {
                ...
                var Result = Laporan_Class.TransferBahanBaku(Request.QueryString["IDTransfer"], Request.QueryString["IDTempatPengirim"].ToInt(), Request.QueryString["IDPengirim"].ToInt(), Request.QueryString["IDTempatPenerima"].ToInt(), Request.QueryString["IDPenerima"].ToInt(), Request.QueryString["EnumStatusTransfer"].ToInt(), Request.QueryString["Keterangan"]);
                ...
                LabelTotalGrandTotalHeaderTransfer.Text = Result["GrandTotal"];
            ...
            LabelJudul.Text = "Transfer Bahan Baku";
