...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="Server">
    Laporan Perpindahan Stok Produk Detail
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitleRight" runat="Server">
    ...
    <a href="Produk.aspx" class="btn btn-danger btn-const">Kembali</a>
</asp:Content>
            ...
            <div class="card-body">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active" id="tabPerpindahanStok">
                        <asp:UpdatePanel ID="UpdatePanelPerpindahanStokProdukDetail" runat="server">
                            <ContentTemplate>
                                    ...
                                    <table class="table table-sm table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr class="thead-light">
                                                ...
                                                <th>
                                                    <asp:DropDownList ID="DropDownListCariPengguna" runat="server" Style="width: 100%;" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="LoadData_Event"></asp:DropDownList></th>
                                                <th>
                                                ...
                                                <th>
                                                    <asp:TextBox ID="TextBoxCariKeterangan" onfocus="this.select();" runat="server" CssClass="form-control input-sm" onkeypress="return Func_ButtonCari(event)" Style="width: 100%;"></asp:TextBox></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <asp:UpdateProgress ID="updateProgressPerpindahanStokProdukDetail" runat="server" AssociatedUpdatePanelID="UpdatePanelPerpindahanStokProdukDetail">
                                    <ProgressTemplate>
