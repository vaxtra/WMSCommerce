...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-6">
                <asp:DropDownList ID="DropDownListCariKombinasiProduk" runat="server" CssClass="select2 w-100" AutoPostBack="true" OnSelectedIndexChanged="LoadData_Event"></asp:DropDownList>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="card">
            <div class="card-header bg-gradient-green">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item"><a href="Produk.aspx" class="nav-link" style="color: #FFFFFF !important;">Mutasi</a></li>
                    <li class="nav-item"><a href="#tabStockCard" id="StockCard-tab" class="nav-link active" data-toggle="tab">Stock Card</a></li>
                                            ...
                                            <asp:Repeater ID="RepeaterLaporan" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="text-right table-warning"><strong><%# Eval("Saldo").ToFormatHargaBulat() %></strong></td>
