<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrint.master" AutoEventWireup="true" CodeFile="PembuanganBahanBakuPrint.aspx.cs" Inherits="WITReport_PerpindahanStok_PembuanganBahanBakuPrint" %>
                ...
                <tbody>
                    <tr class="text-right success" style="font-weight: bold;">
                        ...
                        <td class="text-right" style="vertical-align: middle;">
                            <asp:Label ID="LabelTotalSubtotalHeader" runat="server"></asp:Label>
                        </td>
                    </tr>
                ...
                <tfoot>
                    <tr class="success" style="font-weight: bold;">
                        ...
                        <td style="text-align: right;">
                            <asp:Label ID="LabelTotalSubtotalFooter" runat="server"></asp:Label>
                        </td>
                    </tr>
                </tfoot>
            </table>
