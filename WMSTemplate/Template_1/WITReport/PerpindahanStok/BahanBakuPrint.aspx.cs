...
public partial class WITReport_PerpindahanStok_BahanBakuPrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
            {
                ...
                var Result = Laporan_Class.PerpindahanStokBahanBakuDetail(Request.QueryString["IDTempat"].ToInt(), 0, Request.QueryString["kode"], Request.QueryString["IDBahanBaku"].ToInt(), Request.QueryString["IDSatuan"].ToInt(), Request.QueryString["IDKategori"].ToInt(), Request.QueryString["IDJenisPerpindahanStok"].ToInt(), null, true);
            ...
            LabelJudul.Text = "Perpindahan Stok Bahan Baku";
