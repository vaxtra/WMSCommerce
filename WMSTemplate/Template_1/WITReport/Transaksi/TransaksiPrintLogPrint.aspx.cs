...
public partial class WITReport_Transaksi_TransaksiPrintLogPrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Laporan_Class Laporan_Class = new Laporan_Class(db,
                    (PenggunaLogin)Session["PenggunaLogin"],
                    Request.QueryString["TanggalAwal"].ToDateTime(), Request.QueryString["TanggalAkhir"].ToDateTime(),
                    false);
                ...
                LabelJudul.Text = "Laporan Log Print";
