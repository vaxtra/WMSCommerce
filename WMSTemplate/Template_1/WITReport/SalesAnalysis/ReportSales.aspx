<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPageLaporan.master" AutoEventWireup="true" CodeFile="ReportSales.aspx.cs" Inherits="WITReport_Niion_ReportSales" %>
            ...
            <table class="table table-bordered table-condensed" style="width: 100%">
                <thead>
                    <tr class="active">
                        ...
                        <th class="text-center" colspan="3">Pemasukan / Pengeluaran</th>
                        <th class="text-center" rowspan="2" style="padding-bottom: 20px;">Forecast Qty</th>
                        <th class="text-center" rowspan="2" style="padding-bottom: 20px;">Forecast Income</th>
                        <th class="text-center" rowspan="2" style="padding-bottom: 20px;">Actual Income</th>
                    </tr>
                    <tr>
                        <th class="text-center"> <asp:Label ID="LabelNamaKategoriTempatHeader" runat="server"></asp:Label> </th>
                ...
                <tbody>
                    <asp:Repeater ID="RepeaterDataSales" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%# Eval("Key.TanggalTransaksi").ToFormatTanggal() %></td>
                    ...
                    <tr class="success" style="font-weight: bold;">
                        ...
                        <td class="text-right"><asp:Label ID="LabelTotalQty" runat="server"></asp:Label></td>
