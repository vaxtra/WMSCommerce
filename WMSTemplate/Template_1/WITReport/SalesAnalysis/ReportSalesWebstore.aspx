<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPageLaporan.master" AutoEventWireup="true" CodeFile="ReportSalesWebstore.aspx.cs" Inherits="WITReport_Niion_ReportSalesWebstore" %>
            ...
            <table class="table table-bordered table-condensed" style="width: 100%">
                ...
                <tr class="text-left">
                    <td style="text-align: center">
                        <h4>
                            <asp:Label ID="LabelNamaBulan" runat="server"></asp:Label></h4>
                    </td>
                    <td style="text-align: center">
                        <h4>HEAD OF WEBSTORE</h4>
                    </td>
                    <td style="text-align: center">
                        <h4>  </h4>
                    </td>
            ...
            <table class="table table-bordered table-condensed" style="width: 100%">
                <thead>
                    <tr class="active">
                        ...
                        <th class="text-center" colspan="3">Forecast Webstore Sales</th>
                    ...
                    <tr>
                        ...
                        <th class="text-center">Loss Sale</th>
                    </tr>
                </thead>
                <tbody>
                    <asp:Repeater ID="RepeaterDataSales" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-right"><%# Eval("ActualIncome").ToDecimal() > Eval("ForecastIncome").ToDecimal() ? "-" : (Eval("ActualIncome").ToDecimal() - Eval("ForecastIncome").ToDecimal()).ToFormatHarga() %></td>
                    ...
                    <tr class="success" style="font-weight: bold;">
                        ...
                        <td class="text-right">
                            <asp:Label ID="LabelTotalForecastQuantity" runat="server"></asp:Label></td>
                        <td class="text-right">
                            <asp:Label ID="LabelTotalForecastIncome" runat="server"></asp:Label></td>
                        <td class="text-right">
                            <asp:Label ID="LabelTotalLossSales" runat="server"></asp:Label></td>
                        <td class="text-right">
