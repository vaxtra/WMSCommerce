...
public partial class WITReport_Supplier_Penerimaan : System.Web.UI.Page
{
    ...
    private void LoadData(bool GenerateExcel)
    {
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            var Result = Laporan_Class.PenerimaanPOProduksiBahanBaku(DropDownListCariTempatPurchaseOrder.SelectedValue.ToInt(), TextBoxCariIDPenerimaanPOProduksiBahanBakuPurchaseOrder.Text, TextBoxCariIDPOProduksiBahanBakuPurchaseOrder.Text, 0, DropDownListCariSupplierPurchaseOrder.SelectedValue.ToInt(), DropDownListCariPenggunaPurchaseOrder.SelectedValue.ToInt(), TextBoxCariKeteranganPurchaseOrder.Text);
