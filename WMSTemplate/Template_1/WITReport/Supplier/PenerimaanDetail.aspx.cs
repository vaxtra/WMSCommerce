...
public partial class WITReport_Supplier_PenerimaanDetail : System.Web.UI.Page
{
    ...
    private void LoadData(bool GenerateExcel)
    {
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            var Result = Laporan_Class.PenerimaanPOProduksiBahanBakuDetail(DropDownListCariTempatPurchaseOrder.SelectedValue.ToInt(), TextBoxCariIDPenerimaanPOProduksiBahanBakuPurchaseOrder.Text, TextBoxCariIDPOProduksiBahanBakuPurchaseOrder.Text, 0, DropDownListCariSupplierPurchaseOrder.SelectedValue.ToInt(), DropDownListCariPenggunaPurchaseOrder.SelectedValue.ToInt(), TextBoxCariKodePurchaseOrder.Text, DropDownListCariBahanBakuPurchaseOrder.SelectedValue.ToInt(), DropDownListCariSatuanPurchaseOrder.SelectedValue.ToInt(), DropDownListCariKategoriPurchaseOrder.SelectedValue.ToInt(), false);
