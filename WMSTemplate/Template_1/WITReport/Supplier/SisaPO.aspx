<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="SisaPO.aspx.cs" Inherits="WITReport_Supplier_SisaPO" %>
                                    ...
                                    <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                                        ...
                                        <tbody>
                                            <tr class="success" style="font-weight: bold;">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DropDownListCariSupplierPurchaseOrder" CssClass="select2" Width="100%" runat="server" AutoPostBack="true" OnSelectedIndexChanged="LoadData_EventPurchaseOrder"></asp:DropDownList></td>
                                                <td colspan="7"></td>
                                                <td>
                                            ...
                                            <asp:Repeater ID="RepeaterPurchaseOrder" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td rowspan='<%# Eval("CountBahanBaku") %>'><%# Eval("IDPOProduksiBahanBaku") %></td>
