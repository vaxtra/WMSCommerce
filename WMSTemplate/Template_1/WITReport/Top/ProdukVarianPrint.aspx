<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrint.master" AutoEventWireup="true" CodeFile="ProdukVarianPrint.aspx.cs" Inherits="WITReport_Top_ProdukVarianPrint" %>
    ...
    <div class="row">
        <div class="col-xs-12">
            <table class="table table-bordered table-condensed laporan">
                <thead>
                    <tr class="active">
                        <th style="width:2%;" class="fitSize">No.</th>
                        <th>Produk</th>
                        <th>Varian</th>
                        <th>Warna</th>
                        <th>Kategori</th>
