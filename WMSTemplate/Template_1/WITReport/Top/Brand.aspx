<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Brand.aspx.cs" Inherits="WITAdministrator_Laporan_Transaksi_Transaksi" %>
        ...
        <div class="card">
            <div class="card-header bg-gradient-green">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item"><a href="#tabBrand" id="Brand-tab" class="nav-link active" data-toggle="tab">Brand</a></li>
            ...
            <div class="card-body">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active" id="tabBrand">
