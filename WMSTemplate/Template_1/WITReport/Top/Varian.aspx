<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="Varian.aspx.cs" Inherits="WITAdministrator_Laporan_Transaksi_Transaksi" %>
        ...
        <div class="card">
            <div class="card-header bg-gradient-green">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item"><a href="#tabVarian" id="Varian-tab" class="nav-link active" data-toggle="tab">Varian</a></li>
                    <li class="nav-item"><a href="Kategori.aspx" class="nav-link" style="color: #FFFFFF !important;">Kategori</a></li>
                </ul>
            </div>
            <div class="card-body">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active" id="tabVarian">
