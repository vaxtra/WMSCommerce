<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="ProdukVarian.aspx.cs" Inherits="WITAdministrator_Laporan_Transaksi_Transaksi" %>
        ...
        <div class="card">
            <div class="card-header bg-gradient-green">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item"><a href="#tabProdukVarian" id="ProdukVarian-tab" class="nav-link active" data-toggle="tab">Produk & Varian</a></li>
                    <li class="nav-item"><a href="Produk.aspx" class="nav-link" style="color: #FFFFFF !important;">Produk</a></li>
                    ...
                    <li class="nav-item"><a href="Kategori.aspx" class="nav-link" style="color: #FFFFFF !important;">Kategori</a></li>
                </ul>
            </div>
            <div class="card-body">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active" id="tabProdukVarian">
