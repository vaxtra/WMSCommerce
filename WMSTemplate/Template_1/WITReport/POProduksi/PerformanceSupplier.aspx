<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="PerformanceSupplier.aspx.cs" Inherits="WITReport_POProduksi_PerformanceSupplier" %>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul id="myTab" class="nav nav-tabs">
                ...
                <li class="active"><a href="tabSupplier" id="Supplier-tab" data-toggle="tab">Supplier</a></li>
                                                                ...
                                                                <asp:Repeater ID="RepeaterPerformancePurchaseOrder" runat="server" OnItemCommand="RepeaterPOProduksi_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td class="fitSize">
                                                                                <asp:LinkButton ID="LinkButtonSupplier" runat="server" CommandName="Supplier" CommandArgument='<%# Eval("IDSupplier") %>'><%# Eval("Supplier") %></asp:LinkButton></td>
                                                                            <td class="text-right fitSize"><%# Eval("TotalPO").ToFormatHargaBulat() %></td>
                                                                            <td>
                                                                                <div class="progress" style="margin: 0px;">
                                                                                    <%# Supplier_Class.Persentase(Eval("Pengiriman").ToString()) %>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="progress" style="margin: 0px;">
                                                                                    <%# Supplier_Class.Persentase(Eval("Penerimaan").ToString()) %>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:Repeater ID="RepeaterPerformanceInHouseProduction" runat="server" OnItemCommand="RepeaterPOProduksi_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            <td class="text-center fitSize"><%# Container.ItemIndex + 1 %></td>
                                                                            <td class="fitSize">
                                                                                <asp:LinkButton ID="LinkButtonSupplier" runat="server" CommandName="Tempat" CommandArgument='<%# Eval("IDTempat") %>'><%# Eval("Tempat") %></asp:LinkButton></td>
                                                                            <td class="text-right fitSize"><%# Eval("TotalPO").ToFormatHargaBulat() %></td>
                                                                            <td>
                                                                                <div class="progress" style="margin: 0px;">
                                                                                    <%# Supplier_Class.Persentase(Eval("Pengiriman").ToString()) %>
                                                ...
                                                <div class="panel panel-success">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                                                            ...
                                                            <tbody>
                                                                <asp:Repeater ID="RepeaterPerformanceProductionToSupplier" runat="server" OnItemCommand="RepeaterPOProduksi_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            <td class="text-center fitSize"><%# Container.ItemIndex + 1 %></td>
                                                                            <td class="fitSize">
                                ...
                                <asp:View ID="ViewPOProduksi" runat="server">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <label>Nama</label>
                                            <asp:TextBox ID="TextBoxNamaSupplierTempat" CssClass="form-control input-sm" runat="server" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                                                        ...
                                                        <asp:Repeater ID="RepeaterPurchaseOrder" runat="server" OnItemCommand="RepeaterPOProduksiDetail_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td class="text-center fitSize"><%# Container.ItemIndex + 1 %></td>
                                                                    <td class="fitSize">
                                                                        <asp:LinkButton ID="LinkButtonPengguna" runat="server" CommandName='<%# Eval("IDPOProduksiBahanBaku") %>' CommandArgument='<%# Eval("IDPOProduksiBahanBaku") %>'><%# Eval("IDPOProduksiBahanBaku") %></asp:LinkButton></td>
                                                    ...
                                                    <thead id="headProduksiKeSupplier" runat="server">
                                                        <tr class="info">
                                                            <th colspan="11" style="font-size: 14pt; text-align: left"><strong>PRODUCTION TO SUPPLIER</strong></th>
                                                        </tr>
                                                        <tr class="active">
                                                            <th>No</th>
                                                            <th>ID</th>
