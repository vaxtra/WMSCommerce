...
public partial class WITReport_Vendor_Penagihan : System.Web.UI.Page
{
    ...
    private void LoadData(bool GenerateExcel)
    {
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            var Result = Laporan_Class.POProduksiProdukPenagihan(DropDownListCariTempat.SelectedValue.ToInt(), TextBoxCariID.Text, DropDownListCariVendor.SelectedValue.ToInt(), DropDownListCariPengguna.SelectedValue.ToInt(), TextBoxCariKeterangan.Text);
