...
public partial class WITReport_Vendor_Penerimaan : System.Web.UI.Page
{
    ...
    private void LoadData(bool GenerateExcel)
    {
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            var Result = Laporan_Class.PenerimaanPOProduksiProduk(DropDownListCariTempatPurchaseOrder.SelectedValue.ToInt(), TextBoxCariIDPenerimaanPOProduksiBahanBakuPurchaseOrder.Text, TextBoxCariIDPOProduksiBahanBakuPurchaseOrder.Text, 0, DropDownListCariVendorPurchaseOrder.SelectedValue.ToInt(), DropDownListCariPenggunaPurchaseOrder.SelectedValue.ToInt(), TextBoxCariKeteranganPurchaseOrder.Text);
            ...
            //ButtonPrintPurchaseOrder.OnClientClick = "return popitup('PenerimaanPrint.aspx" + Laporan_Class.TempPencarian + "')";
            #endregion
