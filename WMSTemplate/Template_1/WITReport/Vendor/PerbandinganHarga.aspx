<%@ Page Title="" Language="C#" MasterPageFile="~/assets/MasterPageSidebar.master" AutoEventWireup="true" CodeFile="PerbandinganHarga.aspx.cs" Inherits="WITReport_Vendor_PerbandinganHarga" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="Server">
    Laporan Perbandingan Harga Vendor
</asp:Content>
                    ...
                    <table class="table table-condensed table-hover table-bordered" style="font-size: 12px;">
                        <thead>
                            <tr class="active">
                                ...
                                <th>Produk</th>
                                <th>Varian</th>
                                <asp:Repeater ID="RepeaterVendor" runat="server">
                                    <ItemTemplate>
                            ...
                            <asp:Repeater ID="RepeaterProduk" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <asp:Repeater ID="RepeaterHargaVendor" runat="server" DataSource='<%# Eval("HargaVendor") %>'>
                                            <ItemTemplate>
