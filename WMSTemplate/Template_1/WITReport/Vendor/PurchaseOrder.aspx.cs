...
public partial class WITReport_Vendor_PurchaseOrder : System.Web.UI.Page
{
    ...
    private void LoadData(bool GenerateExcel)
    {
        ...
        using (DataClassesDatabaseDataContext db = new DataClassesDatabaseDataContext())
        {
            ...
            var Result = Laporan_Class.POProduksiProduk(DropDownListCariTempatPurchaseOrder.SelectedValue.ToInt(), TextBoxCariIDPOProduksiProdukPurchaseOrder.Text, 0, DropDownListCariVendorPurchaseOrder.SelectedValue.ToInt(), DropDownListCariPenggunaPurchaseOrder.SelectedValue.ToInt(), TextBoxCariKeteranganPurchaseOrder.Text);
            ...
            //ButtonPrintPurchaseOrder.OnClientClick = "return popitup('PurchaseOrderProductPrint.aspx" + Laporan_Class.TempPencarian + "')";
            #endregion
