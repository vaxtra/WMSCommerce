<%@ Page Title="" Language="C#" MasterPageFile="~/WITPointOfSales/MasterPage.master" AutoEventWireup="true" CodeFile="Transaksi.aspx.cs" Inherits="WITPointOfSales_Marketing_Transaksi" %>
                            ...
                            <asp:Repeater ID="RepeaterTransaksi" runat="server" OnItemCommand="RepeaterTransaksi_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="fitSize" style="vertical-align: middle;"><a href="/WITPointOfSales/Detail.aspx?id=<%# Eval("IDTransaksi") %>&returnUrl=/WITMarketing/Transaksi.aspx"><%# Eval("IDTransaksi") %></a></td>
                                        ...
                                        <td class="fitSize text-right" style="vertical-align: middle;"><%# Pengaturan.FormatHarga(Eval("JumlahProduk")) %></td>
                                        <td class="fitSize text-right" style="vertical-align: middle;"><%# Pengaturan.FormatHarga(Eval("GrandTotal")) %></td>
                                        <td class="fitSize">
                                            <a href="/WITPointOfSales/Default.aspx?id=<%# Eval("IDTransaksi") %>" class='<%# (bool)Eval("UbahOrder") ? "btn btn-sm btn-success" : "btn btn-xs btn-success hidden"  %>'>Point Of Sales >></a>
                                            <a href="Default.aspx?id=<%# Eval("IDTransaksi") %>" class='<%# (bool)Eval("UbahOrder") ? "btn btn-sm btn-info" : "btn btn-xs btn-info hidden" %>'>Ubah Order</a>
                                            <a href="Default.aspx?id=<%# Eval("IDTransaksi") %>" class='<%# (bool)Eval("TransaksiBaru") ? "btn btn-sm btn-primary" : "btn btn-xs btn-primary hidden" %>'>Transaksi Baru</a>
